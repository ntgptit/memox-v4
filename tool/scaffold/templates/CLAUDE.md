...
<!-- FILL: one-line description of what {{PROJECT_NAME}} is. -->
{{PROJECT_NAME}} — <project one-liner>. Stack: {{STACK}}.
...
| --- | --- |
| `{{SRC_DIR}}/**` domain entities | the entity's business doc + `docs/business/glossary.md` |
| `{{SRC_DIR}}/**` use cases / services | matching business doc + decision table |
| `{{SRC_DIR}}/**` repository / data layer | `docs/contracts/repository-contracts/*` + `docs/database/schema-contract.md` |
...
```
✓  `docs/business/<area>/<file>.md`   `{{SRC_DIR}}/...`   `CLAUDE.md`

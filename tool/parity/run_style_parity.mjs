...
const SCREENS = ['library', 'search', 'reminder', 'theme', 'settings', 'statistics', 'flashcard-editor', 'export', 'import', 'deck-detail', 'study-session', 'review', 'player', 'study-result', 'game-picker'];

...
/// Game-recall local prompt (kit `TermCard`): the term with audio + edit
/// controls. Copy is from ARB.
class TermCard extends StatelessWidget {
  const TermCard({required this.term, this.onAudio, this.onEdit, super.key});
          ...
          Row(
            ...
            children: [
              MxIconButton(
                ...
                semanticLabel: l10n.recallAudio,
                onPressed: onAudio,
              ),
              const SizedBox(width: MxSpacing.space2),
              MxIconButton(
                icon: Icons.edit,
                semanticLabel: l10n.recallEdit,

...
// Source of truth: docs/design/MemoX Design System/tokens/elevation.css
...
class MxShadows {
  ...
  static const MxShadows light = MxShadows(
    ...
    lg: [
      BoxShadow(color: Color(0x2E4F46E5), offset: Offset(0, 18), blurRadius: 40),
    ...
    nav: [
      BoxShadow(color: Color(0x33787CB2), offset: Offset(0, -2), blurRadius: 14),
    ],
  );
  ...
  static const MxShadows dark = MxShadows(
    ...
    nav: [
      BoxShadow(color: Color(0x8C000000), offset: Offset(0, -2), blurRadius: 16),

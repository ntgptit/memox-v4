...
**Ngữ cảnh:** người học chọn cặp ngôn ngữ (vd 한국어 → Tiếng Việt), duyệt cây bộ thẻ
(lồng nhau), nắm nhanh khối lượng học và mở một hình thức học từ một nút.
...
nút Play · badge đỏ số thẻ đến hạn. Đáy: nút "Thêm từ" (trái) + FAB "+" (tạo bộ thẻ).

...
>
> Size **L** · Deps **Phase K,H + DM.6** · Branch `build/s02`
...
3. Mark done: append `S.02` to `docs/agent/build/DONE.txt`, run `node tool/design/gen_task_prompts.mjs` (renders `[x]` in the queue), commit.
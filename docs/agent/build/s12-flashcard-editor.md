...
>
> Size **M** · Deps **Phase K + DM.6** · Branch `build/s12`


## Goal

Build the **flashcard-editor** screen + its 2 feature-local component(s), composed from the shared `Mx*` widgets, rendering **DM.6** use-case state via `@riverpod` providers, matching the kit for every state.

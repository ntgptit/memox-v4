...
>
> Size **S** · Deps **I.0** · Branch `build/i1`
...
3. Mark done: append `I.1` to `docs/agent/build/DONE.txt`, run `node tool/design/gen_task_prompts.mjs` (renders `[x]` in the queue), commit.
...
>
> Size **M** · Deps **Phase K,H + DM.5** · Branch `build/s21`
...
3. Mark done: append `S.21` to `docs/agent/build/DONE.txt`, run `node tool/design/gen_task_prompts.mjs` (renders `[x]` in the queue), commit.
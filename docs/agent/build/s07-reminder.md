...
>
> Size **M** · Deps **Phase K** · Branch `build/s07`


## Goal

Build the **reminder** screen + its 2 feature-local component(s), composed from the shared `Mx*` widgets, rendering local UI state, matching the kit for every state.

...
>
> Size **M** · Deps **Phase K,H + DM.8** · Branch `build/s07`
...
3. Mark done: append `S.07` to `docs/agent/build/DONE.txt`, run `node tool/design/gen_task_prompts.mjs` (renders `[x]` in the queue), commit.
...
| Phiên bản | 1.0 |
| Mô hình luồng | 5 lối vào + Play menu + NewLearn 5 chặng + DueReview + Review/Player + result. **NewLearn chặng 1 = Xem lại, chặng 2–5 dùng 4 game thật** (Ghép đôi/Đoán/Nhớ lại/Điền — xem `docs/business/game/game-modes.md`); DueReview = một lượt Nhớ lại chấm SRS. |

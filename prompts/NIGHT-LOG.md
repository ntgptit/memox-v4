...
- DONE: library (3eaf0f55) · search (93bfc353 — dock→filled pill) · reminder (da8b1b2f — time→chip) · theme (dfe8e29f — _Preview→flat) · settings (643c5a47 — appbar large) · statistics (38a84765 — heads→card bg:surface r:20; _StatsCard surface; exempt appbar(scope-toggle)+screen-bg; seed deck/card).
- QUEUE (16): flashcard-editor · export · import · deck-detail · study-session · review · player · study-result · game-picker · game-matching · game-mc · game-recall · game-typing · account · drawer · dashboard.
- NEXT = flashcard-editor.

...
- DONE: library (3eaf0f55) · search (93bfc353 — dock→filled pill) · reminder (da8b1b2f — time→chip surface/r:20/text-tertiary; seed enable; exempt time-edit font/r).
- QUEUE (19): theme · settings · statistics · flashcard-editor · export · import · deck-detail · study-session · review · player · study-result · game-picker · game-matching · game-mc · game-recall · game-typing · account · drawer · dashboard.
- NEXT = theme.

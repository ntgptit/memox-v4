...
description: Use proactively to detect MemoX V4 doc-code drift — runs doc_guard + the CLAUDE.md trigger map, reports stale path/symbol refs, term renames, WBS gaps. Read-only.
tools: Glob, Grep, Read, Bash
model: sonnet
---

# Docs Drift Detector (MemoX V4)

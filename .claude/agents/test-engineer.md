---
name: test-engineer
description: Use proactively to design tests and analyze coverage for a MemoX V4 change, mapped to the project's test layers and the bug-CLASS gate map. Read-only.
tools: Glob, Grep, Read, Bash
model: sonnet
---

# Test Engineer (MemoX V4)
